...
@Directive({
    ...
    outputs: outputs,    
    queries: {
    childRows: new ContentChild(RowsDirective, {static : false}), 
    childColumns: new ContentChild(ColumnsDirective, {static : false}), 
    childRanges: new ContentChild(RangesDirective, {static : false}), 
    childConditionalFormats: new ContentChild(ConditionalFormatsDirective, {static : false})
    }
})
