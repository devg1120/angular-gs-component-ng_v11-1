...
export class Dependency {
    ...
    public getPredecessorStringValue(data: IGanttData): string {
        ...
        //gs const durationUnitTexts: Record<string, unknown> = this.parent.durationUnitTexts;
    ...
    private getOffsetDurationUnit(val: string | number): { duration: number, durationUnit: string } {
        ...
        //gs const durationUnitLabels: Record<string, unknown> = this.parent.durationUnitEditText;
