import { TreeGrid, Filter as TreeGridFilter, 
         FilterSettingsModel as TreeFilterSettingsModel ,
         ColumnModel as TreeGridColumnModel
...
export class Filter {
    ...
    private initiateFiltering(column: ColumnModel): void {
        ...
        var treeinput: TreeGridColumnModel[] =  this.parent.treeGridModule.treeGridColumns ;
        var input: ColumnModel[]  ;
        //TODO  treeinputo => input convert
        const treeColumn: ColumnModel = this.parent.getColumnByField(column.field, input);
