...
export class DiagramContextMenu {
    ...
    private ensureTarget(item: MenuItemModel): boolean {
        ...
        switch (itemText) {
        case 'undo':
        //gs target = this.parent.historyManager && this.parent.historyManager.canUndo ? true : false;
            break;
        case 'redo':
        //gs target = this.parent.historyManager && this.parent.historyManager.canRedo ? true : false;
            break;
        case 'paste':
