...
import { Diagram } from '@devg1120/gs-diagrams';
...
@Component({
    ...
    queries: {
        childLayers: new ContentChild(LayersDirective, { static: false}), 
        childCustomCursor: new ContentChild(CustomCursorsDirective, { static: false}), 
        childConnectors: new ContentChild(ConnectorsDirective, { static: false}), 
        childNodes: new ContentChild(NodesDirective, { static: false})
    }
})
...
export class DiagramComponent extends Diagram implements IComponentBase {
     ...
     * @default undefined
     */
    @ContentChild('annotationTemplate', { static: false})
    @Template()
     ...
     * @default undefined
     */
    @ContentChild('userHandleTemplate', { static: false})
    @Template()
