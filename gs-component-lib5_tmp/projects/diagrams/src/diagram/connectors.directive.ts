...
@Directive({
    ...
    queries: {
        ...
        childFixedUserHandles: new ContentChild(ConnectorFixedUserHandlesDirective, { static :false }), 
        childAnnotations: new ContentChild(ConnectorAnnotationsDirective, { static :false})
    }
})
