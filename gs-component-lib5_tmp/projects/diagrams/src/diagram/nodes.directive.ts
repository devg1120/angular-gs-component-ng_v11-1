...
@Directive({
    ...
    queries: {
        ...
        childFixedUserHandles: new ContentChild(NodeFixedUserHandlesDirective, { static: false}), 
        childAnnotations: new ContentChild(NodeAnnotationsDirective, { static: false}), 
        childPorts: new ContentChild(PortsDirective, { static: false})
    }
})
